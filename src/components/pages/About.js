...
export default function About() {
  return (
    <div style={{ textAlign: 'center', marginTop: '25px', marginBottom: '75px' }}>
      ...
      <img src={process.env.PUBLIC_URL+"/assets/profilepic.jpeg"} alt="My Image" style={{ display: 'block', margin: '0 auto', borderRadius:'50%', overflow:'hidden',boxShadow: '0 0 550px rgba(255, 215, 0, 0.3)'}} />
